...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '南枫Von', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Nanvon’s Blog', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://nanvon.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '南枫, 南枫Von, 小枫大梦', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'nanvon@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
