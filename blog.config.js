...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '南枫', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Nanf’s Blog', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://cibudayi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '词不达意, 博客, 阅读, 写作, 分享, 折腾', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'nanf.hsu@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小枫大梦', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '小枫大梦BLOG', // 站点描述，被notion中的页面描述覆盖
